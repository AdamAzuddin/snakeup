...
function _encodeHeader(message, bb) {
  ...
  if ($type !== undefined) {
    writeVarint32(bb, 16);
    writeVarint32(bb, exports.encodeMessageType[$type]);
  }
};
...
function _decodeHeader(bb) {
  ...
  end_of_message: while (!isAtEnd(bb)) {
    ...
    switch (tag >>> 3) {
      ...
      // optional MessageType type = 2;
      case 2: {
        message.type = exports.decodeMessageType[readVarint32(bb)];
        break;
      }
...
exports.encodeMoveBody = function (message) {
  var bb = popByteBuffer();
  _encodeMoveBody(message, bb);
  return toUint8Array(bb);
}

function _encodeMoveBody(message, bb) {
  // optional MoveDirection offset = 1;
  var $offset = message.offset;
  if ($offset !== undefined) {
    writeVarint32(bb, 8);
    writeVarint32(bb, exports.encodeMoveDirection[$offset]);
  }
};

exports.decodeMoveBody = function (binary) {
  return _decodeMoveBody(wrapByteBuffer(binary));
}

function _decodeMoveBody(bb) {
  var message = {};
  ...
  end_of_message: while (!isAtEnd(bb)) {
    ...
    switch (tag >>> 3) {
      ...
      // optional MoveDirection offset = 1;
      case 1: {
        message.offset = exports.decodeMoveDirection[readVarint32(bb)];
        break;
      }
...
exports.encodeSnakeMessage = function (message) {
  var bb = popByteBuffer();
  _encodeSnakeMessage(message, bb);
  return toUint8Array(bb);
}

function _encodeSnakeMessage(message, bb) {
  ...
  // optional MoveBody move = 2;
  var $move = message.move;
  if ($move !== undefined) {
    writeVarint32(bb, 18);
    var nested = popByteBuffer();
    _encodeMoveBody($move, nested);
    writeVarint32(bb, nested.limit);
    writeByteBuffer(bb, nested);
    pushByteBuffer(nested);
  }
...
exports.decodeSnakeMessage = function (binary) {
  return _decodeSnakeMessage(wrapByteBuffer(binary));
}

function _decodeSnakeMessage(bb) {
  var message = {};
  ...
  end_of_message: while (!isAtEnd(bb)) {
    ...
    switch (tag >>> 3) {
      ...
      case 2: {
        var limit = pushTemporaryLength(bb);
        message.move = _decodeMoveBody(bb);
        bb.limit = limit;
        break;
      }
